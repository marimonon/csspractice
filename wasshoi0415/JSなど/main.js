...
POTEPANCAMP.CAROUSEL = {
	...
	sliderSetting: function() {
		...
		if (width <= 767) {
			...
			$('#jsi-engineer-list').not('.slick-initialized').slick({
				arrows: true,
				dots: true,
				slidesToShow: 1,
				autoplay: false,
			...
			$('#jsi-production-list').not('.slick-initialized').slick({
				arrows: true,
				dots: true,
				slidesToShow: 1,
				autoplay: false,
			...
			$('#jsi-interview-else-list').not('.slick-initialized').slick({
				arrows: true,
				dots: true,
				slidesToShow: 1,
				autoplay: false,
			...
			$('#jsi-engineer-list.slick-initialized').slick('unslick');
			$('#jsi-production-list.slick-initialized').slick('unslick');
			$('#jsi-pick-up-list.slick-initialized').slick('unslick');
			$('#jsi-interview-else-list.slick-initialized').slick('unslick');
			$('.contents-background').height(0);
			$('.pick-up-contents-background').height(0);
		}
	}
};
...
POTEPANCAMP.PLAN_NAV = {
	...
	moveCourse: function(id, isAnimate) {
		...
		this.$htmlBody.animate({scrollTop: courseTop}, isAnimate ? this.SLIDE_SPEED : 0);
  }
}
